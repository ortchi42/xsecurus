...
In order to support loading of multiple wallets in securus-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is securus.cpp.
...
Changes to securus.cpp
----------------------
securus.cpp is the entry point into securus-qt, and as such, will require some minor modifications to provide hooks for
