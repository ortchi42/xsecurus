                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Securus Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Securus address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and securus: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Securus Core"), this);
    aboutAction->setStatusTip(tr("Show information about Securus Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Securus"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Securus addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Securus addresses"));
    ...
    openAction->setStatusTip(tr("Open a Securus: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Securus Core help message to get a list with possible Securus command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Securus Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Securus network", "", count));
}
...
{
    QString strTitle = tr("Securus Core"); // default title
