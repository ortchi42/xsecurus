...
# *Should* be:
# convert securus-1024x1024.png -unsharp 0 -resize $((b*2))x$((b*2)) icon_${b}x${b}@2x.png
...
cp securus-1024x1024.png icon_512x512@2x.png
...
rm -f icon_* securus-1024x1024.png
