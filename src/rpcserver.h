...
extern UniValue setzxscrseed(const UniValue& params, bool fHelp);
extern UniValue getzxscrseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzxscr(const UniValue& params, bool fHelp);
extern UniValue dzxscrstate(const UniValue& params, bool fHelp);
