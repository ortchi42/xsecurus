...
// Copyright (c) 2019 The Securuscoin Developers
 ...
 * Main network
 */
static bool regenerate = false;   //generate genesis 
...
static Checkpoints::MapCheckpoints mapCheckpointsTestnet =
    boost::assign::map_list_of(0, uint256("0x09d61df164a25767dd050beb72c380357374886af57a3590ca34b78549de4152"));
...
public:
    CMainParams()
    {
        ...
        nMinerThreads = 1;
        nTargetTimespan = 1 * 60; // Securuscoin: 1 day
        nTargetSpacing = 1 * 60;  // Securuscoin: 1 minute
        nMaturity = 50;
        ...
        //vSeeds.push_back(CDNSSeedData("0", "85.209.48.159")); // run by Moonshot
        ...
        strObfuscationPoolDummyAddress = "XCYiHgGJJ6xGHqivmdZrYjRnhaYf6AJ2Mp";
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 1;
        nTargetTimespan = 1 * 60; // Securuscoin: 1 day
        nTargetSpacing = 1 * 10;  // Securuscoin: 1 minute
        nMaturity = 15;
        ...
        if (regenerate) {
            ...
            LogPrintf(" hash: 0x%s\n", genesis.GetHash().ToString().c_str());
            LogPrintf(" merklehash: 0x%s\n", genesis.hashMerkleRoot.ToString().c_str());
            assert(hashGenesisBlock == uint256("0x2d16a1aff54a756e8ccd26ee5e0e72972a1ab74ab2cd67f63cfc16f74cdb493a"));
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet securuscoin addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet securuscoin script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet securuscoin BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet securuscoin BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet securuscoin BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // Securuscoin: 1 day
        nTargetSpacing = 1 * 60;        // Securuscoin: 1 minutes
        bnProofOfWorkLimit = ~uint256(0) >> 1;
        genesis.nTime = 1584392500;
        genesis.nBits = 0x207fffff;
        genesis.nNonce = 9781;
